...
latest_message = None  # Stores the latest message received
new_message_received = False  # Global flag
...
async def assistant_message(msg):
    global latest_message  # Declare as global to modify it
    global new_message_received  # Declare as global to modify it
